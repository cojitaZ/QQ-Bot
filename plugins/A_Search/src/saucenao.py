...
class SauceNAO(Search):
    ...
    def parse_result(self):
        ...
        self.debug_info["result_node_count"] = len(soup.select('div.result:not(#result-hidden-notification)'))
        ...
        self.result_list.sort(key=lambda x: self._normalize_similarity(x["similarity"]),reverse=True)
